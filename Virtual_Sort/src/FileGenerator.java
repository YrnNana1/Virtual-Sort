...
* Can be either binary or ASCII text format.
* 
...
enum FileType {
   ...
   /**
    * Represents an ASCII text file format.
    */
   ASCII
};
...
public class FileGenerator {
   /**
    * Number of bytes used to store a key in a record.
    */
   static public final int BYTES_IN_KEY = Short.BYTES;

   /**
    * Number of bytes used to store a value in a record.
    */
   static public final int BYTES_IN_VALUE = Short.BYTES;

   /**
    * Total number of bytes per record (key + value).
    */
   static public final int BYTES_PER_RECORD = BYTES_IN_KEY + BYTES_IN_VALUE;

   /**
    * Number of records stored in one block.
    */
   ...
   private final int numBlocks; // numblocks which is an int
   private final String fname; // fname which is a string
   private Random rng; // rng which is random
